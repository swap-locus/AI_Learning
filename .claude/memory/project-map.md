...
- Entry point: `backend/app.py` → run from `backend/`, `python app.py` (port 8080)
...
**AI_Support_Bot** — multi-provider support bot with classifier routing
- Entry point: `uvicorn backend.api:app --reload` from `AI_Support_Bot/` root
